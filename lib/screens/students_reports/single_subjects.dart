...
class SingleSubjectA extends StatefulWidget {
  const SingleSubjectA(
      {super.key,
  ...
  @override
  State<SingleSubjectA> createState() => _SingleSubjectAState();
}

class _SingleSubjectAState extends State<SingleSubjectA> {
...
//other class codes
  ...
  fetchData() async {
    ...
    try {
      ...
      log("Attendance Dates:${response.data}");
  ...
  Future<void> fetchDataN() async {
    ...
    try {
      ...
      if (data['errorCode'] == '0000') {
        // Clear the attendance dates list before adding new dates
