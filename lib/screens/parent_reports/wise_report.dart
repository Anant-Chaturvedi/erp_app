...
class WiseReport extends StatefulWidget {
  const WiseReport(
      {super.key,
  ...
  @override
  State<WiseReport> createState() => _WiseReportState();
}

class _WiseReportState extends State<WiseReport> {
      ...
      child: Scaffold(
        ...
        child: Column(
          children: [
            ...
            // Custom(markedDatesBlack: [], markedDatesYellow: attendanceDates),
            SizedBox(
              height: mq.height * .026,
            ),
            Padding(
              padding: EdgeInsets.only(
                  left: mq.width * .05,
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      // Text('Total lectures: $totalLecture\nAttended lectures: $totalAttendedLectures\nNot attended lectures: $totalNotAttendedLectures')
                    ],
                  ),
                ],
              ),
