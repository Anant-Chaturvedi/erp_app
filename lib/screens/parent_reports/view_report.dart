...
import 'package:erp_app/screens/parent_reports/single_subjects.dart';
    ...
    return WillPopScope(
      onWillPop: () async {
        Navigator.pushAndRemoveUntil(
            context,
            CupertinoPageRoute(builder: (_) => const StudentDash()),
            (route) => false);
        return true;
      },
      child: SafeArea(
